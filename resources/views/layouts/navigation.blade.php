   ...
   <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
       <ul class="space-y-2">
        <div class="flex flex-row gap-4 mb-7">
          ...
          <img src="/aset/buku.webp" class="w-1/6 h-1/6" alt="Logo Perpustakaan Pesat">
          <h1 class="dark:text-white text-black">Perpustakaan Pesat</h1 class="dark:text-white text-black">
        </div>
           <li>
           ...
           <li> 
            ...
            <li>
                ...
                <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route("dashboard") }}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Admin</a>
                    </li>
                    <li>
            ...
            @if(Auth::user()->role == 'anggota')
                <li> 
                    ...
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <a href={{ route('anggota.index') }} class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Pinjam Buku</a>
                        </li>
                        <li>
                            <a href={{ route('anggota.riwayat') }} class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Riwayat Peminjaman Buku</a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Informasi</a>
                        </li>
       ...
       <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
           <li>
               <a href="https://github.com/FadhlanPutra/Library_Management_Laravel" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
        ...
        <li>
            <a href="{{ route('profile.edit') }}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path fill-rule="evenodd" d="M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 9a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a4 4 0 0 0-4-4h-4Z" clip-rule="evenodd"/>
                </svg>
           ...
           <li>
                <form id="logout-form" action={{ route('logout') }} method="POST">
                    @csrf
                    <button data-message="Logout Sekarang?" data-form="logout-form" type="button" class="confirm-button w-full flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                        <svg data-message="Logout Sekarang?" data-form="logout-form" class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path data-message="Logout Sekarang?" data-form="logout-form" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H8m12 0-4 4m4-4-4-4M9 4H7a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h2"/>
                          </svg>                                                
                              <span data-message="Logout Sekarang?" data-form="logout-form" class="ml-3 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">Keluar</span>
                    </button>
                </form>
           </li>
        <li>
            ...
            <select id="theme-selector" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
